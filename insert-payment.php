        ...
        <div class="sidebar">
            ...
            <div class="profile-section">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "insert into table_payment (metode_pembayaran, nama_akun) values
		('$metode_pembayaran', '$nama_akun')";
            ...
            <div class="container-2">
                <div class="form-container">
                    <div class="header">
                        ...
                        <button class="back-button" onclick="window.location.href='payment.php'">Back</button>
                    </div>

                    <form id="form-payment" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">

                        <label for="metodepembayaran">Metode Pembayaran:</label>
                        <input type="text" id="metode-pembayaran" name="metode_pembayaran" placeholder="Metode">

                        <label for="nama-akun">Nomor / Nama Akun:</label>
                        <input type="text" id="nama-akun" name="nama_akun" placeholder="Nomor / Nama">

                        <button type="submit" class="submit-button">Tambah Metode</button>
                    </form>
                </div>
            </div>
</body>
