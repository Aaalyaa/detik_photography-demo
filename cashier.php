            ...
            <div class="container-2">
                <div class="header-2">
                    ...
                    <div class="search-container">
                        ...
                        <a href="insert-kasir.php" class="add-product-btn" role="button">Tambah Kasir</a>
                </div>
                ...
                <div id="table-container">
                    <table border="1">
                        ...
                        $query = "SELECT * FROM table_karyawan WHERE role = 'kasir'";

                        if (!empty($search)) {
                            $query .= " AND (id_karyawan LIKE ? OR full_nama LIKE ? )";
                        }
                            ...
                            while ($data = $result->fetch_assoc()) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail-kasir.php?id_karyawan=<?php echo $data['id_karyawan']; ?>"
                                                class="edit-btn" role="button">See Detail</a>
                                    </tr>
                                </tbody>
                                <?php
                            }
                    ...
                    if (!empty($search)) {
                        echo "<div style='text-align:center; margin-top: 20px;'>
                                <a href='cashier.php' class='back-btn'>Kembali ke Daftar Lengkap</a>
                              </div>";
                    }
                    ?>
                </div>
