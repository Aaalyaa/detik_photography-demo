            ...
            <div class="container-2">
                ...
                <form id="editForm"
                    ...
                    <div class="form-group">
                        <label for="id-lama">ID Admin:</label>
                    ...
                    <div class="form-group">
                        <label for="full-nama">Nama Admin:</label>
                        ...
                        <div class="current-photo">
                            <?php if (!empty($data['foto'])): ?>
                                <img src="data:image/jpeg;base64,<?php echo base64_encode($data['foto']); ?>"
                                    alt="Foto Admin" style="width:150px;height:150px;object-fit:cover;">
                            <?php else: ?>
                    ...
                    <div class="form-group">
                        <label for="no-telp">Nomor Telepon Admin:</label>
