        ...
        <div class="main-content">
            ...
            <div class="container-2">
                <div class="header-2">
                    ...
                    <a href="insert-payment.php" class="add-product-btn" role="button">Tambah Metode</a>
                </div>
                ...
                <div id="table-container">
                    <table border="1">
                        ...
                        $query = "SELECT * FROM table_payment";

                        if (!empty($search)) {
                            $query .= " WHERE no_payment LIKE '%$search%' OR metode_pembayaran LIKE '%$search%'";
                        }
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            <tbody>
                                <tr>
                                    <td><?php echo $data["no_payment"]; ?></td>
                                    <td><?php echo $data["metode_pembayaran"]; ?></td>
                                    <td><?php echo $data["nama_akun"]; ?></td>
                                    <td>
                                        <a href="edit-payment.php?no_payment=<?php echo $data['no_payment']; ?>"
                                            class="edit-btn" role="button">Edit</a>
                                </tr>
                            </tbody>
                            <?php
                            }
                    ...
                    if (!empty($search)) {
                        echo "<div style='text-align:center; margin-top: 20px;'>
                                <a href='payment.php' class='back-btn'>Kembali ke Daftar Lengkap</a>
                              </div>";
                    }
                    ?>
                </div>
