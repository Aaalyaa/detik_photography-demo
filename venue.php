            ...
            <div class="container-2">
                <div class="header-2">
                    ...
                    <div class="search-container">
                        <form method="GET" action="venue.php">
                            <input type="text" name="search" placeholder="Cari nama/kode" required>
                            <button type="submit" class="search-btn">Search</button>
                        </form>
                    </div>
                    <a href="insert-venue.php" class="add-product-btn" role="button">Tambah Venue</a>
                </div>
                ...
                <div id="table-container">
                    <table border="1">
                        ...
                        $query = "SELECT * FROM table_venue";

                        if (!empty($search)) {
                            $query .= " WHERE id_venue LIKE '%$search%' OR lokasi LIKE '%$search%'";
                        }
                        ...
                        if ($result->num_rows > 0) {
                            while ($data = $result->fetch_assoc()) {
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo $data["id_venue"]; ?></td>
                                        <td><?php echo $data["lokasi"]; ?></td>
                                        <td><?php echo $data["biaya"]; ?></td>
                                        <td>
                                            <a href="edit-venue.php?id_venue=<?php echo $data['id_venue']; ?>" class="edit-btn"
                                                role="button">Edit</a>
                                    </tr>
                                </tbody>
                                <?php
                    ...
                    if (!empty($search)) {
                        echo "<div style='text-align:center; margin-top: 20px;'>
                                <a href='venue.php' class='back-btn'>Kembali ke Daftar Lengkap</a>
                              </div>";
                    }
                    ?>
                </div>
