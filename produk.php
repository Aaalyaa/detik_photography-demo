        ...
        <div class="main-content">
            ...
            <div class="container-2">
                <div class="header-2">
                    ...
                    <a href="insert.php" class="add-product-btn" role="button">Tambah Paket</a>
                </div>
                ...
                <div id="table-container">
                    <table border="1">
                        ...
                        $query = "SELECT id_paket, nama_paket, deskripsi_paket, harga FROM table_paket";

                        if (!empty($search)) {
                            $query .= " WHERE id_paket LIKE '%$search%' OR nama_paket LIKE '%$search%'";
                        }
                            ...
                            while ($data = $result->fetch_assoc()) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo nl2br($data["deskripsi_paket"]); ?></td>
                                        <td><?php echo number_format($data["harga"], 2, ',', '.'); ?></td>
                                        <td>
                                            <a href="edit.php?id_paket=<?php echo $data['id_paket']; ?>" class="edit-btn"
                                                role="button">Edit</a>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    if (!empty($search)) {
                        echo "<div style='text-align:center; margin-top: 20px;'>
                                <a href='produk.php' class='back-btn'>Kembali ke Daftar Lengkap</a>
                              </div>";
                    }
                    ?>
                </div>
